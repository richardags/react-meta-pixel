...
interface Props {
  ...
  autoConfig?: boolean;
  /**
   * Controlling Facebook Pixel's History API Tracking
   *
   * @description By default, Facebook Pixel automatically tracks PageView events when your Single Page Application (SPA) updates the browser history via history.pushState(). This ensures seamless URL and referrer tracking, supporting features like Custom URL conversions.
   *
   * @default false
   */
